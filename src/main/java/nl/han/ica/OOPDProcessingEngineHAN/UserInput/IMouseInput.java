...
public interface IMouseInput {
	...
	/**
	 * This event is fired when the GameEngine received g mouse press action.
	...
	/**
	 * This event is fired when the GameEngine received g mouse release action.
	 * @param x The x value is the relative mouse position calculated with the position of the world (TileMap).
	 * @param y The y value is the relative mouse position calculated with the position of the world (TileMap).
	 */
	...
	/**
	 * This event is fired when the GameEngine received g mouse click action.
	 * @param x The x value is the relative mouse position calculated with the position of the world (TileMap).
	 * @param y The y value is the relative mouse position calculated with the position of the world (TileMap).
	 */
	...
	/**
	 * This event is fired when the GameEngine received g mouse move action.
	 * @param x The x value is the relative mouse position calculated with the position of the world (TileMap).
	 * @param y The y value is the relative mouse position calculated with the position of the world (TileMap).
	 */
	...
	/**
	 * This event is fired when the GameEngine received g mouse drag action.
	 * @param x The x value is the relative mouse position calculated with the position of the world (TileMap).
	 * @param y The y value is the relative mouse position calculated with the position of the world (TileMap).
	 */
	...
	/**
	 * This event is fired when the GameEngine received g mouse wheel action.
	 * @param direction
	 */
